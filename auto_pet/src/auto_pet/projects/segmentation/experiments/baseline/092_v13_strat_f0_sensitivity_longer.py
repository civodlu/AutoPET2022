if __name__ == '__main__':
    ...
    configuration = {
        'datasets': {
            ...
            'splits_name': default('splits_name', 'autopet_stratified_v1_kfold0.json'),
        },
        'training': {
            'device': default('device', 'cuda:7'),
            'batch_size': 10,
        ...
        'data': {
            ...
            'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/092_v13_strat_f0_sensitivity/best_dice_foreground_e4600_0.6643484655772629.model',
        },
        'tracking': {
