...
if __name__ == '__main__':
    ...
    configuration = {
        ...
        'data': {
            ...
            #'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/098_v13_stacking_linear/best_dice_foreground_e100_0.6836552213298326.model',
            #'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/098_v13_stacking_linear_v2/last.model'
            #'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/098_v13_stacking_linear_v3/best_dice_e1000_0.5134566501845679.model'
            #'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/098_v13_stacking_linear_v3/best_dice_e1100_0.5469414720232089.model'
            'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/098_v13_stacking_linear_v3/best_dice_e500_0.5048483769139531.model'
        },
        'tracking': {
            'derived_from': '098_v13_stacking_linear_v3.py',
    ...
    def main():
        ...
        try:        
            ...
            models = [copy.deepcopy(Model()) for c in range(4)]
            model_ensemble = ModelEnsemble(models)
            load_model(model_ensemble, configuration.data['config_start'], device=torch.device(configuration.training['device'].split(';')[0]), strict=True)
