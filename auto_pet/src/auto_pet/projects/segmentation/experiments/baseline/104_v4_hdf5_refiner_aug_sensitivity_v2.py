if __name__ == '__main__':
    ...
    from auto_pet.projects.segmentation.model_refiner_multiclass_deepsupervision_configured_v1 import Refiner_dice_ce_fov_v1_ds_lung_soft_hot_boundary_sensitivity as Model
    ...
    configuration = {
        ...
        'training': {
            ...
            'eval_inference_every_X_epoch': default('eval_inference_every_X_epoch', 1000, output_type=int),
        ...
        'data': {
            ...
            'preprocessing': Preprocessing(post_processing_fn=TransformCascadedPredictionPrecomputedV2(
                precomputed_root='/mnt/datasets/ludovic/AutoPET/logging2/utils_007_regenerate_results_v13_final_ensemble_098_v13_stacking_linear_v3_e500/wholebody_inference')
            ),
            ...
            'config_start': '/mnt/datasets/ludovic/AutoPET/logging2/101_v4_hdf5_refiner_aug/rolling_save_e_6000.model',
        },
        'tracking': {
            'derived_from': '048_v4_hdf5_refiner.py',
    ...
    def main():
        ...
        try:                    
            optimizer = trw.train.OptimizerAdamW(
                ...
                weight_decay=configuration.training['weight_decay']).scheduler_step_lr(
                    step_size=2000,
                    gamma=0.3
            ).clip_gradient_norm()
