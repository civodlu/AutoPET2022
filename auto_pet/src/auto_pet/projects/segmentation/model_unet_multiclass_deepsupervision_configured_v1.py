...
SimpleMulticlassUNet_dice_ce_fov_v9_ds_lung_soft_hot_boundary_attention = partial(
    ...
    model=trw.layers.UNetBase(
        ...
        up_block_fn=partial(Up, block=partial(
            ...
            merge_layer_fn=trw.layers.unet_attention.MergeBlockAttention_Gating_Input, 
            deconv_block=trw.layers.blocks.BlockUpsampleNnConvNormActivation)
        )
    ),
    with_deep_supervision=True,
    boundary_loss_factor=1.0,
...
from trw.basic_typing import KernelSize, Padding, Stride
from typing import Union, Sequence
from trw.layers import BlockMerge, BlockDeconvNormActivation, BlockNonLocal, linear_embedding
