...
class ModelLstm(nn.Module):
    ...
    def forward(self, batch):
        ...
        output_classification = trw.train.OutputClassification(o_raw, sequence_output.unsqueeze(1), weights=weighting)
        ...
        seg_map_output = trw.train.OutputEmbedding(seg_map, clean_loss_term_each_batch=True)

        return {
            #'sequence': trw.train.OutputLoss(loss.mean(dim=1)),
