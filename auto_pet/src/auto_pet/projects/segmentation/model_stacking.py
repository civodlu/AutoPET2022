...
import numpy as np
import copy
from auto_pet.projects.segmentation.model_unet_multiclass_deepsupervision import LossDiceCrossEntropyFocal2, output_postprocessing_fn
from auto_pet.projects.segmentation.model_refiner_multiclass_deepsupervision_configured_v1 import Refiner
...
class ModelStacking(nn.Module):
    def __init__(self,
        ...
        self.output_fn = partial(trw.train.OutputSegmentation, criterion_fn=loss_fn, output_postprocessing=output_postprocessing_fn)
